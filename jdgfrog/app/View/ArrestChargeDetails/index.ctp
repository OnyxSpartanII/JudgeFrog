<div class="arrestChargeDetails index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('bails_BailId'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($arrestChargeDetail['ArrestChargeDetail']['bails_BailId']); ?>&nbsp;</td>
		<td><?php echo h($arrestChargeDetail['ArrestChargeDetail']['defendants_DefendantId']); ?>&nbsp;</td>
		<td class="actions">
