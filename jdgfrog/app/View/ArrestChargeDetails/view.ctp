...
<h2><?php echo __('Arrest Charge Detail'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Bails BailId'); ?></dt>
		<dd>
			<?php echo h($arrestChargeDetail['ArrestChargeDetail']['bails_BailId']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Defendants DefendantId'); ?></dt>
		<dd>
			<?php echo h($arrestChargeDetail['ArrestChargeDetail']['defendants_DefendantId']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
