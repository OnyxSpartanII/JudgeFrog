			...
			<div class="contact-main">	
				...
				<div class="col-md-6 case_creation_form" id="form_style" style="float:inherit">
						...
						<fieldset id="OCGFS">
								...
								<?php
									echo $this->Form->input('OCName1', 			array('default' => $case['DataInProgress']['OCName1'], 'type' => 'text', 'label' => 'Name of Organized Crime Group 1'));
									...
									echo $this->Form->input('OCRace1', 			array('default' => $case['DataInProgress']['OCRace1'], 'label' => '', 'options' => array('0' => 'None', '1' => 'Black','2' => 'White','3' => 'Hispanic','4' => 'Asian','5' => 'Other'),'empty'=>'Race'));
									...
									echo $this->Form->input('OCName2', 			array('default' => $case['DataInProgress']['OCName2'], 'type' => 'text', 'label' => 'Name of Organized Crime Group 2'));
									...
									echo $this->Form->input('OCRace2', 			array('default' => $case['DataInProgress']['OCRace2'], 'label' => '', 'options' => array('0' => 'None', '1' => 'Black', '2' => 'White', '3' => 'Hispanic', '4' => 'Asian', '5' => 'Other'),'empty'=>'Race'));
