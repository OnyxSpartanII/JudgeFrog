					...
					<div class="case_top_bar">
						...
						<div class="progress">
							...
							<fieldset id="caseInfoFS">
								...
								echo $this->Form->input('CaseNum', array( 'label' => 'Case Number', 'placeholder' => '23-c3-2015'));
								...
								echo $this->Form->input('JudgeName', array('label' => 'Judge Name','placeholder' => 'John Smith', 'type' => 'text'));
