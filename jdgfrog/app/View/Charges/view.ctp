...
<h2><?php echo __('Charge'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($charge['Charge']['ACDId']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('ACD CHD CaseId'); ?></dt>
		<dd>
			<?php echo h($charge['Charge']['ACD_CHD_CaseId']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('ACD CHD DefendantId'); ?></dt>
		<dd>
			<?php echo h($charge['Charge']['ACD_CHD_DefendantId']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
