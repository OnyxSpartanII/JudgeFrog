	  	    	  ...
	  	    	  <div class="sap_tabs">	
				     <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						  <ul class="resp-tabs-list">
						  	  <li class="resp-tab-item-res" aria-controls="tab_item-0" role="tab"><span>Organization and Government</span></li>
						  	  <li class="resp-tab-item-res" aria-controls="tab_item-1" role="tab"><span>Publications and Reports</span></li>
							  <li class="resp-tab-item-res" aria-controls="tab_item-2" role="tab"><span>Federal Statutes</span></li>
							  <div class="clear"></div>
						  </ul>				  	 
