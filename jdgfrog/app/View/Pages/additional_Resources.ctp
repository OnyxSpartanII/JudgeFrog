                  ...
                  <div class="sap_tabs">    
                     <div id="horizontalTab" style="display: block; width: 100%; margin: 0px; border:none">
                        <ul style="font-size:1.1em; width: 100%;">
                          <li><a href="#about-htd">ORGANIZATION AND GOVERNMENT</a></li>
                          <li><a href="#meth">PUBLICATIONS AND REPORTS</a></li>
                          <li><a href="#prin-inv">FEDERAL STATUTES</a></li>
                        </ul>
                        <div id="about-htd">
                            <div class="facts">
                        ...
                        <div id="prin-inv">
                            <div class="facts">
                              ...
                              <?php echo $this->Html->image('van.jpg', array('alt' => 'Vanessa Bouche', 'style' => 'float:left; padding-right:10px;' )); ?>
                                ...
                                <?php echo $this->Html->image('mic.jpg', array('alt' => 'Michael Bachmann', 'style' => 'float:left; padding-right:10px; padding-top:10px;' )); ?>
